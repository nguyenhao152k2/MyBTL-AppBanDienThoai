...
public class DtIphoneAdapter extends FirebaseRecyclerAdapter<SanPhamMoi, DtIphoneAdapter.myViewHolder> {
    //
     ...
     * @param options
     */
    public DtIphoneAdapter(@NonNull FirebaseRecyclerOptions<SanPhamMoi> options, Context context) {
        super(options);
    ...
    public class myViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        // Tạo setter cho biến ItemClickListener
