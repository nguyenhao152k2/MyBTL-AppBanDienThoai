...
public class DtOppoAdapter extends FirebaseRecyclerAdapter<SanPhamMoi, DtOppoAdapter.myViewHolder> {
     ...
     * @param options
     */
    public DtOppoAdapter(@NonNull FirebaseRecyclerOptions<SanPhamMoi> options, Context context) {
        super(options);
