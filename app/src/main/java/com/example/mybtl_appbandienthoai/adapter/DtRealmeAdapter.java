...
public class DtRealmeAdapter extends FirebaseRecyclerAdapter<SanPhamMoi, DtRealmeAdapter.myViewHolder> {
    //
     ...
     * @param options
     */
    public DtRealmeAdapter(@NonNull FirebaseRecyclerOptions<SanPhamMoi> options, Context context) {
        super(options);
