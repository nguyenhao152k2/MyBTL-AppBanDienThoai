...
public class DtXiaomiAdapter extends FirebaseRecyclerAdapter<SanPhamMoi, DtXiaomiAdapter.myViewHolder> {
    //
     ...
     * @param options
     */
    public DtXiaomiAdapter(@NonNull FirebaseRecyclerOptions<SanPhamMoi> options, Context context) {
        super(options);
