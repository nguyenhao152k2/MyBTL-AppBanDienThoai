...
import com.example.mybtl_appbandienthoai.model.DtVivo;
...
public class DtVivoAdapter extends FirebaseRecyclerAdapter<SanPhamMoi, DtVivoAdapter.myViewHolder> {
    //
     ...
     * @param options
     */
    public DtVivoAdapter(@NonNull FirebaseRecyclerOptions<SanPhamMoi> options, Context context) {
        super(options);
